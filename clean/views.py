...
services = [
    ...
    },
    {
        ...
        "images": ["/static/assets/images/bathroom.jpeg",  "/static/assets/images/bathroom2.jpeg"]
    },
    {
        "id": 5,
        ...
        "images": ["/static/assets/images/rug4.jpeg", "/static/assets/images/rug1.jpeg", "/static/assets/images/rug2.jpeg"]
    },
...
class ContactAPiView(APIView):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            try:
                send_mail(subject, plain_message, 'info@gevitoclean.com', ['info@gevitoclean.com'], html_message=html_message)
                return JsonResponse({'success': True, 'message': "Welcome to Gevito Cleaning Services ,your place of Comfort, we'll be in touch with you shortly."})
...
class QuoteAPiView(APIView):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            # Prepare the HTML and plain text versions of the message
            html_message = render_to_string('quote_form.html', {'name': name, 'email': email, 'phone': phone, 'service': service, 'type': type})
            plain_message = strip_tags(html_message)

            try:
                send_mail('Quote', plain_message, 'info@gevitoclean.com', ['info@gevitoclean.com'], html_message=html_message)
                return JsonResponse({'success': True, 'message': "Welcome to Gevito Cleaning Services ,your place of Comfort, we'll be in touch with you shortly."})
            except BadHeaderError as e:
                # Handle BadHeaderError
                error_message = str(e)
